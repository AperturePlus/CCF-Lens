...
export { GoogleScholarAdapter, createGoogleScholarAdapter } from './google-scholar-adapter'
export type { GoogleScholarPaperInfo, JournalExtractResult } from './google-scholar-adapter'
